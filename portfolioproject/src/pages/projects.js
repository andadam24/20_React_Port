        ...
        <div className="col">
            <div className="container text-white">
                <h4 className="name text-white">CovTracker</h4>
                    <img src="images/CovTracker.png" className="img.center" alt="CovTracker site" />
        ...
        <div className="col">
            <div class="container text-white">
                <h4 className="name text-white">DayPlanner</h4>
                    <img src="images/DayPlanner.png" className="img.center" alt="DayPlanner site" />
        ...
        <div className="col">
            <div className="container text-white">
                <h4 className="name text-white">RePost</h4>
                    <img src="images/RePost.png" className="img.center" alt="RePost site" />
